...
public class FireJobService extends JobService {
    public static final String TAG = FireJobService.class.getSimpleName();
        ...
        client.get(URL, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    ...
                    int status = objectSecurity.getInt("kebakaran");

                    if (status == 1) {
                        String title = getResources().getString(R.string.fire_title);
                        String message = getResources().getString(R.string.fire_message);
                        int notifId = 201;
                        showFireNotification(getApplicationContext(), title, message, notifId);
                        jobFinished(job, false);
                    }
    ...
    private void showFireNotification(Context context, String title, String message, int notifId) {
